...
%% Generated on: 23.02.2016 23:54:51
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% lpf_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    lpf_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    lpf_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    lpf_fir_comp_coeff(31,80e6,4e6,true,false)


function lpf_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	% Validate number of input arguments
	error(nargchk(0, 6, nargin));

	%%%%%% CIC filter parameters %%%%%%
	R = 1024;					%% Decimation factor
	...
	filename = 'lpf_fir_comp_coeff.txt';
